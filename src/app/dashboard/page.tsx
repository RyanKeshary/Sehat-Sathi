...
const mockAppointments = [
  {
    ...
    date: new Date(Date.now() + 2 * 24 * 60 * 60 * 1000 + 4 * 60 * 60 * 1000), // 2 days 4 hours from now
    status: "Confirmed",
    ...
    <div className="p-6 md:p-8 max-w-7xl mx-auto pb-24">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
        <div>
          ...
          <h1 className="text-3xl font-bold text-[#0A2540] flex items-center gap-2" style={{ fontFamily: 'Plus Jakarta Sans, sans-serif' }}>
          ...
          <section>
            ...
            <div className="space-y-4">
              {mockAppointments.map((appt) => {
                const isWithin5Mins = appt.date.getTime() - Date.now() < 5 * 60 * 1000 && appt.date.getTime() > Date.now();
                return (
                      ...
                      <div>
                        ...
                        <div className="flex items-center gap-3 text-xs font-medium">
                          <span className="flex items-center gap-1.5 text-slate-600 bg-slate-100 px-2 py-1 rounded-md">
                            <Clock size={14} />
                            {appt.date.toLocaleString('en-US', { month: 'short', day: 'numeric', hour: 'numeric', minute: '2-digit' })}
                          </span>
