...
export const LANGUAGES: Language[] = [
  ...
  { id: "pa", name: "Punjabi", nativeName: "ਪੰਜਾਬੀ", flag: "🇮🇳", placeholder: "ਆਪਣੇ ਲੱਛਣ ਦੱਸੋ..." },
  { id: "bn", name: "Bengali", nativeName: "বাংলা", flag: "🇮🇳", placeholder: "আপনার উপসর্গ বর্ণনা করুন..." },
  { id: "te", name: "Telugu", nativeName: "తెలుగు", flag: "🇮🇳", placeholder: "మీ లక్షణాలను వివరించండి..." },
  ...
  { id: "kn", name: "Kannada", nativeName: "ಕನ್ನಡ", flag: "🇮🇳", placeholder: "ನಿಮ್ಮ ರೋಗಲಕ್ಷಣಗಳನ್ನು ವಿವರಿಸಿ..." },
  { id: "or", name: "Odia", nativeName: "ଓଡ଼ିଆ", flag: "🇮🇳", placeholder: "ଆପଣଙ୍କର ଲକ୍ଷଣ ବର୍ଣ୍ଣନା କରନ୍ତୁ..." },
  { id: "ml", name: "Malayalam", nativeName: "മലയാളം", flag: "🇮🇳", placeholder: "നിങ്ങളുടെ ലക്ഷണങ്ങൾ വിശദീകരിക്കുക..." },
];
